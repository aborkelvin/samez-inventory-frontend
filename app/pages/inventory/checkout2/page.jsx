...
//this will help in new features addition
...
const Checkout = () => {
  ...
  //current feature being worked on. dont allow overquantity
  const handleQuantityChange = (productId, quantity, quantityAvailable) => {
    if (quantity > 0 && quantity <= quantityAvailable) {
      ...
      alert('Quantity input exceeds available quantity');
    }
  };
        ...
        {selectedProducts.length === 0 ? (
          ...
          <table className="w-full">
            ...
            <tbody>
                ...
                <tr key={product._id} className="border-b hover:bg-gray-100 text-left">
                  ...
                  <td className="py-2 px-1">
                    <input
                      ...
                      onChange={e => handleQuantityChange(product._id, parseInt(e.target.value), product.quantityAvailable)}
                    />
                  </td>
              ...
              <tr>
                <td colSpan="4" className="py-2 px-1 font-bold text-right">Total Price:</td>
